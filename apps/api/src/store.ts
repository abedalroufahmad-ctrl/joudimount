...
function mapTransaction(doc: any): Transaction {
  ...
  return {
    ...
    storagePhotos: Array.isArray(doc.storagePhotos)
      ...
      : undefined,
    deliveryOrderCharge: doc.deliveryOrderCharge,
    customsDeclarationCharge: doc.customsDeclarationCharge,
    freightShippingCompanyCharge: doc.freightShippingCompanyCharge,
    customsBillCdrCopyCharge: doc.customsBillCdrCopyCharge,
    portChargeDpw: doc.portChargeDpw,
    inspectionForMerciCharge: doc.inspectionForMerciCharge,
    clearingCharges: doc.clearingCharges,
    exitCertificateCharge: doc.exitCertificateCharge,
    manifestSgaServicesCharge: doc.manifestSgaServicesCharge,
    gatePassCharge: doc.gatePassCharge,
    toCharge: doc.toCharge,
    labourCharge: doc.labourCharge,
    repackingCharge: doc.repackingCharge,
    exitSummitDoCustomsCharge: doc.exitSummitDoCustomsCharge,
